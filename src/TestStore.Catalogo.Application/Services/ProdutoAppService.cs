...
namespace TestStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        //servido de dominio fazendo persistencia das entidades: nao ha necessidade
        //nao ha problema chamar o repositorio diretamente
